...
AGENTS_README="$REPO_ROOT/claude/.claude/agent-notes/README.md"
USE_CASE_DATA="$REPO_ROOT/claude/.claude/agents/use-case-data-patterns.md"
USE_CASE_DATA_SOURCE="$REPO_ROOT/claude/.claude/agent-notes/use-case-data-patterns-source-notes.md"
