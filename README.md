...
| **Clarity** | Co-writes, rewrites, reviews, or diagnoses reader-facing prose at sentence level while preserving facts, attribution, medium, and the author's voice | [→ addyosmani/clarity](https://github.com/addyosmani/clarity) |
| **Simple English** | Writes plain technical prose for lay and non-native readers; explicit STE requests add ASD-STE100 vocabulary discipline | [→ AminBlg/SimpleEnglish](https://github.com/AminBlg/SimpleEnglish) |
...
| Reader-facing prose feels generic, hollow, or AI-shaped | [clarity](https://github.com/addyosmani/clarity) | Preserve truth and voice; fix substance before surface patterns |
| Technical prose must be plain, translatable, or ASD-STE100-style | [simple-english](https://github.com/AminBlg/SimpleEnglish) | Short active sentences, one meaning per term, condition before command |
...
./install-claude.sh --no-external                        # Skip all external community skills, including clarity and simple-english
...
- ✅ `~/.claude/skills/` — installed via [skills.sh](https://skills.sh) with `npx skills@1.5.22 add`; every source revision and selected skill name is explicit:
  ...
  - [addyosmani/clarity](https://github.com/addyosmani/clarity) — co-write, rewrite, review, and deterministic prose diagnostics without inventing facts or voice
  - [AminBlg/SimpleEnglish](https://github.com/AminBlg/SimpleEnglish) — plain and ASD-STE100-style technical writing for lay, non-native, and translation-oriented readers
...
- **[Addy Osmani](https://github.com/addyosmani)** - The web quality skills install from reviewed commit [`95d6e25`](https://github.com/addyosmani/web-quality-skills/tree/95d6e255afe1596b557d7a8498517884438f5b3a). `clarity` installs unmodified from reviewed commit [`9e30711`](https://github.com/addyosmani/clarity/tree/9e3071196d5d26f26c58f5d7c995890b35a94499), including its standard-library-only prose diagnostics. Both sources use the MIT License. The `api-design` skill is adapted from Addy's MIT-licensed [`api-and-interface-design` skill](https://github.com/addyosmani/agent-skills/blob/7676817c12a1317454ae3898a0c5c1eacf5dd3d5/skills/api-and-interface-design/SKILL.md). Local history records no original upstream import revision, so `7676817c12a1317454ae3898a0c5c1eacf5dd3d5` is documented only as an immutable audit baseline; detailed source notes, local departures, and the upstream notice live beside the skill.

- **[Amin Boulegroun](https://github.com/AminBlg)** - `simple-english` installs unmodified from reviewed commit [`080a862`](https://github.com/AminBlg/SimpleEnglish/tree/080a862b2e80d5fe19a2fbddd3de76f7d580279e/skills/simple-english), under the pinned [MIT License](https://github.com/AminBlg/SimpleEnglish/blob/080a862b2e80d5fe19a2fbddd3de76f7d580279e/LICENSE). Its upstream deterministic linter and published eval results were reviewed at the same commit; the installed runtime is the skill and its references.
